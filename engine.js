...
//   gamesTable.push(
//       [{rowSpan: 2, content: 'Bets'}, 'Won', 'Lost', 'Total'], [formatGames(results.gamesWon), formatGames(results.gamesLost), formatGames(results.games)],
//       [{rowSpan: 2, content: 'Games'}, 'Played', 'Skipped', 'Total'], [1, 2, 3]
//   );

//   balanceTable.push(
//     [{colSpan}]
//       ['Start Balance', 'End Balance', ],
//       [{colSpan: 2, content: 10000}, {colSpan:2, content: 20000}]
//   )
//   console.log(gamesTable.toString());
//     console.log();
//     console.log(' Starting Balance : ' + Math.round(results.startingBalance / 100))
